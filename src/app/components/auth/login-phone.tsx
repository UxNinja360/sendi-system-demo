  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pr-12 pl-4 py-3 bg-[#fafafa] dark:bg-[#0a0a0a] border border-[#e5e5e5] dark:border-[#262626] rounded-xl text-[#0d0d12] dark:text-[#fafafa] placeholder:text-[#a3a3a3] focus:outline-none focus:ring-2 focus:ring-[#02B74F] focus:border-transparent transition-all"
                  maxLength={10}
                  dir="ltr"
                />
              </div>
        ...
        {/* Footer */}
        <p className="text-center text-sm text-[#666d80] dark:text-[#a3a3a3] mt-6">
          בהמשך אתה מאשר את{' '}

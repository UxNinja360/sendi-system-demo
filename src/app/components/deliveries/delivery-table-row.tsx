      ...
      <td className={`${TABLE_ACTIONS_BODY_BASE_CLASS} ${heightClasses.py} ${actionsCellBg}`} onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-end gap-0.5" data-no-row-click>
          ...
          <button
            ...
            className="p-1 rounded-lg hover:bg-[#f5f5f5] dark:hover:bg-[#262626] text-[#737373] dark:text-[#a3a3a3] hover:text-[#0d0d12] dark:hover:text-[#fafafa] transition-colors"
            aria-label={`פעולות למשלוח ${delivery.orderNumber}`}
            aria-haspopup="menu"
            aria-expanded={menuOpen}
          >
            <MoreHorizontal className={heightClasses.iconSize} />
          </button>

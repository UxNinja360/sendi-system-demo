    ...
    <div className="min-h-screen flex items-center justify-center bg-[#fafafa] dark:bg-[#0a0a0a] p-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <button
            onClick={() => navigate(-1)}
            className="flex items-center justify-center gap-2 px-6 py-3 bg-white dark:bg-[#171717] border border-[#e5e5e5] dark:border-[#262626] hover:bg-[#f5f5f5] dark:hover:bg-[#262626] text-[#0d0d12] dark:text-[#fafafa] font-medium rounded-xl transition-colors"
          >
            <ArrowRight size={20} />
            חזור אחורה
          </button>

...
export const SettingsPage: React.FC<{ onLogout?: () => void }> = ({ onLogout }) => {
  ...
  const { isDark, toggleDark, autoThemeEnabled, setAutoThemeEnabled } = useTheme();
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-4 px-3 py-3 md:px-5 md:py-5">
          ...
          >
            ...
            <SettingRow
              ...
              title={TEXT.autoTheme}
              hint={TEXT.autoThemeHint}
              control={<Toggle checked={autoThemeEnabled} onChange={() => setAutoThemeEnabled(!autoThemeEnabled)} />}
            />
            <SettingRow

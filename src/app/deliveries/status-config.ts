...
export const STATUS_CONFIG: Record<DeliveryStatus, StatusConfig> = {
  ...
  delivered: {
    ...
    tableColor: 'text-blue-500 dark:text-blue-400',
    sidePanelColor: 'text-blue-600 dark:text-blue-400',
    sidePanelBg: 'bg-blue-50 dark:bg-blue-950/40',
    sidePanelBorder: 'border-blue-200 dark:border-blue-800',
    icon: CheckCircle2,
